class Problem145:
    ...
    DESCRIPTION = "Some positive integers  have the property that the sum  consists entirely of odd (decimal) digits." \
                  "For instance, 36+63 = 99  and . We will call such numbers reversible. " \
    ...
    def answer(self) -> int:
        ...
        We have the following rules:
            ...
            - 3-digit, i.e., n = (a,b,c)
                ...
                - b + b < 10
                => 5*20 = 100
            - 4-digit, i.e., n = (a,b,c,d)
                - a, d different from 0
                - a + d < 10 and (a + d) % 2 = 1
                - c + b < 10 and (c + b) % 2 = 1
                => 20*30 = 600
            - 5-digit, i.e., n = (a, b, c, d, e)
                => NO SOLUTION
            - 6-digit, i.e., n = (a, b, c, d, e, f)
                - a, f different from 0
                - a + f < 10 and (a + f) % 2 = 1
                - e + b < 10 and (e + b) % 2 = 1
                - c + d < 10 and (d + c) % 2 = 1
                => 20*30*30 = 18_000
            - 7-digit, i.e., n = (a, b, c, d, e, f, g)
                - a, g different from 0
                - g + a > 10 and (g + a) % 2 = 1
                - f + b < 10 and (b + f) % 2 = 0
                - e + c > 10 and (e + c) % 2 = 1
                => 50_000
            - 8-digit, i.e., n = (a, b, c, d, e, f, g, h)
                ...
                - e + d < 10 and (e + d) % 2 = 1
                => 20*30*30*30 = 540_000
            - 9-digit, i.e., n = (a, b, c, d, e, f, g, h, i)
                => NO SOLUTION
        """
